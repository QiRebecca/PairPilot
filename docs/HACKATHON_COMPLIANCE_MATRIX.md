...
| Use at least one Google agent framework | Google ADK Python agents with model-selected tools | ADK agent definitions and pinned dependency | ADK runtime on Cloud Run | Live agent-turn audit panel | **Pending** |
