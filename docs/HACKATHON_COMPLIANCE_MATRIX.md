...
| Hosted project URL if available; hosting encouraged | Public product without sign-in | React app, FastAPI API, multi-stage Dockerfile | Public `pairpilot-orchestrator` URL, revision `00009-poy` | Browser address bar shows `.run.app` | **Verified** |
