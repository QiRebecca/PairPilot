...
| Candidate deployment and production promotion | PARTIAL | Isolated revision `00063-qec`, immutable digest, prefix, topic, OIDC subscription and DLQ are live at zero traffic; migration apply, visual/failure-injection gates and production promotion remain |
