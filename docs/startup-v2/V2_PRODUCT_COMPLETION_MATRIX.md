...
| Versioned migration framework | LIVE_VERIFIED | Candidate V2_002 was applied; a later 1,983-document dry-run reports zero mutation, blockers or review items |
